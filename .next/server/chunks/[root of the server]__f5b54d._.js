...
"[project]/prisma/prisma-client.ts [app-route] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
"[project]/src/lib/calc-cart-item-total-amount.ts [app-route] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
async function getCartTotalAmount(cartId) {
    const userCartAfterUpdate = await __TURBOPACK__imported__module__$5b$project$5d2f$prisma$2f$prisma$2d$client$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].cart.findFirst({
        where: {
            id: cartId
        },
        include: {
    ...
    const totalAmount = userCartAfterUpdate?.items.reduce((acc, item)=>acc + (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$calc$2d$cart$2d$item$2d$total$2d$amount$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["calcCartItemTotalAmount"])(item), 0);
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__f5b54d._.js.map