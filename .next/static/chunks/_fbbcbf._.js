(globalThis.TURBOPACK = globalThis.TURBOPACK || []).push(["static/chunks/_fbbcbf._.js", {
...
const ChooseProductModal = ({ product })=>{
    ...
    const onSubmit = async (productItemId, ingredients)=>{
        try {
            ...
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$hot$2d$toast$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].success(product.name + 'has been added to the cart');
            router.back();
        } catch (error) {
...
_s(ChooseProductModal, "zSl6T5OkdbFJgqkcqYgYc9E634c=", false, function() {
    return [
...
//# sourceMappingURL=_fbbcbf._.js.map